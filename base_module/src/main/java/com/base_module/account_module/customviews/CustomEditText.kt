package com.base_module.account_module.customviews
...
import com.base_module.databinding.LayoutCustomEditTextBinding
    ...
    private fun initViews(attrs: AttributeSet){
        ...
        context.theme.obtainStyledAttributes(attrs, R.styleable.CustomEditText, 0, 0).apply {
            binding?.apply {
                ...
                etInput.inputType = getInt(R.styleable.CustomEditText_android_inputType, InputType.TYPE_NULL)
                etInput.isEnabled = getBoolean(R.styleable.CustomEditText_isEnabled,true)
                etInput.imeOptions = getInt(R.styleable.CustomEditText_android_imeOptions,EditorInfo.IME_ACTION_NEXT)
            }
        }
    }
